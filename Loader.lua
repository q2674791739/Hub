...
getgenv().Abysall = {
    Environment = loadstring(game:HttpGet(BaseUrl .. "Environment.luau"))(),
    ESPLibrary = loadstring(game:HttpGet(BaseUrl .. "ESP.luau"))(),
    Legit = true,
}
...
Abysall.Interface = loadstring(game:HttpGet(BaseUrl .. "Interface.luau"))()
